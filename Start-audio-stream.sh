...
echo -e "\033[0;49;32m\n\nEjemplo/URL: \n\n\033[0m"
echo -e "https://m.youtube.com/watch?v=VuDAvwO9rRU\n"
...
echo -e -n "\n\033[0;49;32m [\033[0m-\033[0;49;32m]\033[0m \033[0;49;32mDigite selección: \033[0m"
read q
...
echo -e  "\033[0;49;32m\n\n=>\033[0m Si la extracción fue exitosa, omita reintentar de nuevo.\033[0;49;32m\n\n=>\033[0m Si ocurre un error y finalizo el proceso sin obtener la extracción de la urlstream en formato almacenable en el directorio de DESCARGAS por defecto, verifique su conexión, la url, y constate la información ingresada si ocurren errores, en el proceso.\n\n\033[0;49;32m=>\033[0m Si ocurren errores que requieran autenticación de cuenta o usuario, o omita esa plataforma, e intente extraer con una urlstream de otra plataforma de streaming u de la misma plataforma del mismo autor músical, tema músical,etcétera, en formato legible e almacenable de audio en formato Mp3."
