...
echo -e "\e[0;31m" "\n\nFinalizo el proceso de instalación, para utilizar los servicios ofrecidos de YT-DLP en YTDLP-TERMUX visualice con el comando cat README.md en el directorio del repositorio clonado, ejemplo: '~ $ cat README.md', e utilice según su preferencia."
